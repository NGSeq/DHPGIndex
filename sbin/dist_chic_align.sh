...
align() {
    ...
    ssh  -tt -o "StrictHostKeyChecking no" node-$1 /opt/chic/src/chic_align -v1 -t 16 -o /mnt/tmp/aligned.sam /mnt/tmp/chr$i.fa /mnt/tmp/reads_1.fq /mnt/tmp/reads_2.fq &> chic_align$i.log
