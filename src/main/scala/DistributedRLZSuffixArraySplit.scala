...
object DistributedRLZSuffixArraySplit {
  ...
  def main(args: Array[String]) {
    ...
    val sa1 = scala.io.Source.fromFile(localradix+"00").getLines.toArray
    val sa2 = scala.io.Source.fromFile(localradix+"01").getLines.toArray
    val sa3 = scala.io.Source.fromFile(localradix+"02").getLines.toArray
    val sa4 = scala.io.Source.fromFile(localradix+"03").getLines.toArray
